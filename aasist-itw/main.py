...
def main(args: argparse.Namespace) -> None:
    ...
    if args.eval:
        if not args.wild:
            ...
            eval_trial_path = str(database_path) + "/in_the_wild.protocol.txt"
            ...
            print("Model loaded : {}".format(config["model_path"]))
            print("Start evaluation...")
            produce_evaluation_file_wild(eval_loader, model, device,
                                    eval_score_path, eval_trial_path)
...
def produce_evaluation_file_wild(
    data_loader: DataLoader,
    model,
    device: torch.device,
    save_path: str,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--wild",
        action="store_true",
        help="when this flag is given, evaluates given model on \"in-the-wild\" data and exit")
