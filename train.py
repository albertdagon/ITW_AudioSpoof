...
from evaluation_utils import calculate_tDCF_EER
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Audio spoofing detection system")
    parser.add_argument("--config", type=str, required=True, help="configuration file for the system")
    parser.add_argument("--output_dir", type=str, help="output directory for results", default="./exp_result")
